...
public class Example {
	...
	// 예외는 두 종류로 구분됨
	// 1) Checked Exception : 필수적으로 예외 처리 구문 작성
	// 2) Unchecked Exception : 선택적으로 예외 처리 구문 작성
...
//      String input = br.readLine(); // == sc.nextLine();
		...
		// -> readLin()메서드는 IOException을 던질 가능성이 있기 때문에
		// 호출 시 반드시 예외 처리를 하시오.
		// --> Checked Exception
		...
		// -> 코드 작성 시 예외처리를 반드시 하라고컴파일 에러가 발생하지 않음
	...
	public void ex3() {
		...
		try {
			...
			// catch (Exception e) { 앞에있으면 생기는 문제
