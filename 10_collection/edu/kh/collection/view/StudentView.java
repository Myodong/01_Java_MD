...
public class StudentView {
		...
		do {
			...
			default: System.out.println(" 잘못 입력 하셨습니다.");
	         ...
	         System.out.println();
	        	 ...
	        	 input = -1; // 첫 반복 시 잘못 입력된 경우 while 문이 종료되지 않도록 하는 값
	...
	public void addStudent() {
		...
		while (true) {
			...
			if (gender == 'M'|| gender == 'F') {
				...
				System.out.println("[error] M / F 만 입력해주세요.");
			}
	...
	public void selectAll() {
		...
		// 향상된 for문
		// - 배열 또는 컬렉션의 모든 요소를 
		//	 처음 부터 끝까지 순차 접근할 때 사용하는 for 문 (foreach문)
	...
	public void removeStudent() {
		...
		if (s==null) {
			...
			System.out.println(s.getName()+"학생의 정보가 삭제되었습니다.2");
		}
	...
	public void selectStudent1() {
		...
		if (resultList.isEmpty()) {
			// resultList.isEmpty() : 리스트에 저장된 요소가 없으면 true
			// resultList.size()==0 사용가능
