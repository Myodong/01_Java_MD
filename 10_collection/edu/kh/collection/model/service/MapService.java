...
public class MapService {
	...
	/* Map : key와 vlaue 한 쌍이 데이터가 되어 이를 모아둔 객체
	 * 
...
//		System.out.println(student.get("ddress"));
//		System.out.println(student.get("Score"));
		
		// keyset() : Map 에서 Key 부분을 추출하여 Set 형태로 반환
		
		// for/while/if 문 작성 시 {} 없다면
		// 다음 한줄에(다음 세미콜론 까지)에만 영향을 미친다.
