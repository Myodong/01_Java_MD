...
public class ListService {
	...
	/* List : 자료들을 순차적으로 나열한 자료구조(배열과 비슷합)
	 * -> interface
	 * 
	 * - 인덱스를 이용해 순서를 유지
	 * - 중복 값 저장 가능 (인텍스 번호로 구분 가능하기 때문)
	 * 
	 * - List를 상속받아 구현한 클래스
	...
	public void ex1() {
		...
		// - 특징
		// 1) 크기 제약이 없다
		// 2) 추가, 삭제, 수정, 정령 등의 기능이 구현되어 있다.
		// 3) 여러 타입의 객체를 저장할 수 있다.
		//		-> Object 참조 변수의 묶음
		
		
		//java.util 패키지
//		ArrayList list = new ArrayList();// 기본생성자 -> 10칸 짜리 생성
		...
		// remove(int index) : index 위치의 객체를 제거한다.
