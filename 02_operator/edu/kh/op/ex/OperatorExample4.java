...
public class OperatorExample4 {
	...
	public static void main(String[] args) {
			...
			//&&(and) 연산자 : 둘다 true이면 true, 나머진 false
			//~와, 그리고(~이고), ~이면서(~면서), ~부터 ~까지, ~사이
		
			int a = 101;
			//a는 100 이상 이면서 짝수인가?
			boolean result1 = a>=100;//a는 100이상? trus
			...
			System.out.println("b는 1부터 10 사이의 정수 인가?" + (result3 && result4));
			
			
			//||(or) 연산자 : 둘다 false이면 false, 나머진 true
